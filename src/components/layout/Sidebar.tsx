  ...
  return (
    <div className="px-3 py-2 flex-grow flex flex-col">
      ...
      <div className="mb-5">
        ...
        >
          <Sparkles size={16} className={activePage === 'VioletAI' ? 'text-purple-400' : 'text-[#A1A1AA]'} />
          <span className={activePage === 'VioletAI' ? 'text-white' : ''}>Violet AI</span>
          {activePage !== 'VioletAI' && (
